  ...
  return (
    <Card className="bg-transparent border-0 shadow-none w-full">
      <CardContent className="p-0">
        <div
          className="bg-card/40 backdrop-blur-sm border-2 border-dotted rounded-lg p-12 text-center transition-colors duration-300 border-slate-400 hover:border-primary"
        >
