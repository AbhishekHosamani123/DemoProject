  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
            "flex h-screen flex-col bg-sidebar text-sidebar-foreground p-2",
            className
        )}
        {...props}
        >
