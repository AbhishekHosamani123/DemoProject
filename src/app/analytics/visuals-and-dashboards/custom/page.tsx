    ...
    <div className="flex-1 container mx-auto px-4 py-8 sm:px-6 lg:px-8 flex flex-col items-center">
      <div className="w-full max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Link href="/analytics/visuals-and-dashboards/custom/automated">
                <Card className="text-center p-8 h-full flex flex-col justify-center items-center hover:bg-primary/5 hover:border-primary/50 transition-all transform hover:-translate-y-1">
             ...
             <Link href="/analytics/visuals-and-dashboards/custom/manual">
                <Card className="text-center p-8 h-full flex flex-col justify-center items-center hover:bg-primary/5 hover:border-primary/50 transition-all transform hover:-translate-y-1">
