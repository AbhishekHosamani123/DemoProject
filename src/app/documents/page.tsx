...
const documentTypes = [
  {
    title: "BRD",
    icon: <Briefcase className="h-6 w-6 mb-2 text-primary" />,
  ...
  {
    title: "FRD",
    icon: <FunctionSquare className="h-6 w-6 mb-2 text-primary" />,
    description: "Functional Requirements",
    href: "#",
  },
  {
    title: "TDD",
    icon: <GitBranchPlus className="h-6 w-6 mb-2 text-primary" />,
  ...
  {
    title: "Gap Analysis",
    icon: <Scaling className="h-6 w-6 mb-2 text-primary" />,
